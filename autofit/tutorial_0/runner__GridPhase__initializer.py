...
if __name__ == "__main__":
    ...
    python_script_filename = "runner_with_selfcal__GridPhase__lens__sie_and_subhalo__source__ellipticalsersic__data__len__sie_and_subhalo__source__ellipticalsersic__phase_errors"
