...
if __name__ == "__main__":
    ...
    folder, centre_0_lower_limit, centre_0_upper_limit, centre_1_lower_limit, centre_1_upper_limit = sys.argv
    centre_0_lower_limit = float(centre_0_lower_limit)
    centre_0_upper_limit = float(centre_0_upper_limit)
    centre_1_lower_limit = float(centre_1_lower_limit)
    centre_1_upper_limit = float(centre_1_upper_limit)
    ...
    subhalo_model.redshift_object = lens_redshift
    subhalo_model.redshift_source = source_redshift
