...
if __name__ == "__main__":
    ...
    model_1 = profiles.Kinematical(
        ...
        maximum_velocity=125.0,
        velocity_dispersion=25.0
    )
    ...
    source_plane_mask = al.Mask.elliptical(
        shape_2d=grid_3d.shape_2d,
        major_axis_radius=0.75,
        axis_ratio=0.8,
        phi=30.0,
        pixel_scales=grid_3d.pixel_scales,
        sub_size=grid_3d.sub_size,
    ...
    # plt.figure()
    # plt.imshow(source_plane_mask)
    # plt.show()
    # exit()

    cube_masked = copy.copy(cube)
    cube_masked[:, source_plane_mask] = np.nan
    plot_utils.plot_cube(
        cube=cube_masked,
        ncols=8,
        figsize=(16.25, 8)
    ...
    # cube_moment_0 = spectral_utils.moment_0(
    #     cube=cube,
    #     velocities=np.arange(
    #         -cube.shape[0] * z_step_kms / 2.0,
    #         cube.shape[0] * z_step_kms / 2.0,
    #         z_step_kms
    #     )
    # )
    # cube_moment_1 = spectral_utils.moment_1(
    #     cube=cube,
    #     velocities=np.arange(
    #         -cube.shape[0] * z_step_kms / 2.0,
    #         cube.shape[0] * z_step_kms / 2.0,
    ...
    # )
    # plt.figure()
    # plt.imshow(cube_moment_0)
    # #plt.imshow(cube_moment_1)
    # plt.show()


    # # NOTE: Plotting
    # spectrum = spectral_utils.get_spectrum_from_cube(
    #     cube=cube
    # )
    ...
    # plt.plot(spectrum_model_1, color="b")
    # plt.plot(spectrum_model_2, color="r")
    # plt.show()
    # exit()
